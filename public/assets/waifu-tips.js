...
// const DOMAIN = 'http://8.130.8.205:16789/live2d_api-master/'
// const DOMAIN = 'live2d_api-master/'
const DOMAIN = 'https://live2d.faruzan.cn/live2d_api-master/'
// const DOMAIN = 'http://localhost:8999/Api/'
var re = /x/;
console.log(re);
...
function loadModel(modelId, modelTexturesId){
    ...
    loadlive2d('live2d', DOMAIN+'get/?id='+modelId+'-'+modelTexturesId, console.log('live2d','模型 '+modelId+'-'+modelTexturesId+' 加载完成'));
}
...
function loadRandModel(){
    ...
    $.ajax({
        cache: false,
        url: DOMAIN+modelTexturesRandMode+'_textures/?id='+modelId+'-'+modelTexturesId,
        dataType: "json",
        success: function (result){
...
function loadOtherModel(){
    ...
    $.ajax({
        ...
        // url: 'https://live2d.jixiaob.cn/'+modelTexturesRandMode+'/?id='+modelId,
        url: DOMAIN+modelTexturesRandMode+'/?id='+modelId,
        dataType: "json",
        success: function (result){
